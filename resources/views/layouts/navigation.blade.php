                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if( Auth::user()->isSuperAdmin() || Auth::user()->isAdmin() || Auth::user()->isMember())
                        <x-nav-link
                            ...
                            :active="request()->routeIs('short-urls.*')">
                            Short URLs
                        </x-nav-link>
                    @endif
                </div>                              
    ...
    <div :class="{ 'block': open, 'hidden': !open }"
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                @if(Auth::user()->isSuperAdmin())
                    <x-responsive-nav-link :href="route('companies.index')"> Companies </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('invitations.create')">Send Invitation</x-responsive-nav-link>
                @endif    
