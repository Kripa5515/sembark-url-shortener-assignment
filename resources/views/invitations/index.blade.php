            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between mb-6">
                        <h3 class="text-lg font-medium">All Invitations</h3>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($invitations as $invitation)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $invitation->company->name ?? 'N/A' }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $invitation->role }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $invitation->expires_at }}</td>
